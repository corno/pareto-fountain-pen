...
import * as s_semi_lines from "../../semi_lines/transformers/text"

import * as sh from "../../../../../shorthands/block"

export const Group: _pi.Transformer_With_Parameters<d_in.Group, d_out.Text, d_x.Parameters> = ($, $p) => s_semi_lines.Lines(
...
export const Block_Part: _pi.Transformer_With_Parameters<d_in.Block_Part, d_out.Text, d_x.Parameters> = ($, $p) => s_semi_lines.Lines(
