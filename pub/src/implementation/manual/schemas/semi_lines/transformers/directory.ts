...
export const Directory: _pi.Transformer_With_Parameters<d_in.Directory, d_out.Directory, d_block_serialize.Parameters> = ($, $p) => $.__d_map(($) => _p.decide.state($, ($): d_out.Directory.D => {
    switch ($[0]) {
