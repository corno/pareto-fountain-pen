...
import type * as d_target from "../../interface/generated/liana/schemas/prose/data.js"
import type * as d_text from "../../interface/generated/liana/schemas/list_of_characters/data.js"
...
export namespace pg {
    ...
    export const sentences = (
        sentences: p_.Normal_List<d_target.Sentence>
    ): d_target.Paragraph => ['sentences', p_.list(sentences)]
}

export const sentence = (
    phrases: p_.Normal_List<d_target.Phrase>
...
export namespace ph {
    ...
    export const rich = (
        items: p_.Normal_List<d_target.Phrase>,
